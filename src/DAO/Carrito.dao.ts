import { ICarrito, ICarritoAdd } from "@Interfaces/carrito.interface";
...
class CarritoDAO{
    ...
    async getAllPaginate( page: number, limit: number ): Promise<PaginateResult<ICarrito>>{
        const options = {
    ...
    async updateCart( id: string, cart: ICarritoAdd ): Promise<ICarrito>{
